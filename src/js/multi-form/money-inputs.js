export function PriceInputsMultiForm() {
  const multiForm = document.querySelector("#multi-form");
  const currencyInputs = multiForm.querySelectorAll("[data-price]");
  const currencyOptions = multiForm.querySelectorAll(".currencyInput");
  const prefixOptionsText = multiForm.querySelectorAll(".prefixCurrency");
